...
CREATE TABLE public.songs_artist (
    ...
    gender_list character varying(1024),
    followers character varying(1024)
);
...
ALTER TABLE public.songs_artist ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.songs_artist_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.songs_song ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: songs_song_artist_id_5a5484fb; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX songs_song_artist_id_5a5484fb ON public.songs_song USING btree (artist_id);
...
--
-- Name: songs_song songs_song_artist_id_5a5484fb_fk_songs_artist_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.songs_song
    ADD CONSTRAINT songs_song_artist_id_5a5484fb_fk_songs_artist_id FOREIGN KEY (artist_id) REFERENCES public.songs_artist(id) DEFERRABLE INITIALLY DEFERRED;
